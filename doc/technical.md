...
- 游戏：Endless Slice
- 类型：action
- 简述：Swipe to slice the farm — pig, cow, chicken, sheep heads arc up; drag through to split them open. Chain hits for combos (×2, ×3, MASSIVE). Wagyu +100. Hit the no-cleaver sign and you're out.
...
- 平台元信息：meta.title=Endless Slice；cover_url=/poster.png；category=action；uuid=2296d825-fc9c-441a-a761-a9e055218c93
...
- `src/EndlessSlice/EndlessSlice.tsx`
- `src/EndlessSlice/types.ts`
- `src/EndlessSlice/EndlessSlice.less`
- `src/EndlessSlice/index.ts`
- `src/EndlessSlice/utils/draw.ts`
- `src/EndlessSlice/utils/food.ts`
- `src/EndlessSlice/utils/audio.ts`
